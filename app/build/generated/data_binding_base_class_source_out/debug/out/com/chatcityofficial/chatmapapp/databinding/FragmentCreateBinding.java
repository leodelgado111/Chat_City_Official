...
public final class FragmentCreateBinding implements ViewBinding {
  ...
  private FragmentCreateBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textCreate) {
  ...
  public static FragmentCreateBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentCreateBinding((ConstraintLayout) rootView, textCreate);
    }
