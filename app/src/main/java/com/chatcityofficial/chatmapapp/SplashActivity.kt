...
class SplashActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Enable edge-to-edge display BEFORE setting content view
        enableEdgeToEdge()
        
        // Set the theme before setting content view
        setTheme(R.style.Theme_ChatCityOfficial_Splash)
    ...
    private fun enableEdgeToEdge() {
        ...
        // Ensure the layout extends into the cutout areas (notches)
